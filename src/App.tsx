...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      {/* Floating Sticky WhatsApp Button (Official WhatsApp Icon) */}
      <a
      ...
      >
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M16 2.5C8.544 2.5 2.5 8.544 2.5 16C2.5 18.528 3.197 20.893 4.406 22.923L2.7 29.3L9.232 27.632C11.206 28.777 13.526 29.5 16 29.5C23.456 29.5 29.5 23.456 29.5 16C29.5 8.544 23.456 2.5 16 2.5ZM16 5C22.075 5 27 9.925 27 16C27 22.075 22.075 27 16 27C13.882 27 11.91 26.398 10.237 25.357L9.805 25.088L5.786 26.113L6.85 22.183L6.554 21.734C5.467 20.089 4.833 18.118 4.833 16C4.833 9.925 9.925 5 16 5ZM11.66 9.38C11.41 9.38 11 9.47 10.66 9.84C10.31 10.22 9.34 11.13 9.34 12.98C9.34 14.83 10.69 16.61 10.87 16.86C11.06 17.11 13.51 20.89 17.26 22.51C18.15 22.9 18.85 23.13 19.39 23.3C20.29 23.59 21.1 23.54 21.74 23.45C22.46 23.34 23.94 22.55 24.25 21.68C24.56 20.8 24.56 20.05 24.47 19.9C24.38 19.75 24.13 19.65 23.76 19.47C23.38 19.28 21.56 18.39 21.22 18.26C20.88 18.14 20.63 18.08 20.38 18.45C20.13 18.83 19.42 19.65 19.2 19.9C18.99 20.15 18.77 20.18 18.4 19.99C18.02 19.81 16.83 19.42 15.42 18.16C14.32 17.17 13.57 15.96 13.35 15.58C13.13 15.21 13.33 15.01 13.52 14.82C13.69 14.65 13.89 14.39 14.08 14.17C14.27 13.95 14.33 13.8 14.46 13.55C14.58 13.3 14.52 13.08 14.43 12.9C14.33 12.71 13.62 10.96 13.31 10.24C13.02 9.53 12.72 9.63 12.5 9.62C12.29 9.61 12.04 9.38 11.66 9.38Z"
            fill="#FFFFFF"
          />
        </svg>
      </a>
